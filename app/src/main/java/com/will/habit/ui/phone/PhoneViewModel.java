...
public class PhoneViewModel extends BaseViewModel<DemoRepository> {
    //用户名的绑定
    ...
    public class UIChangeObservable {
        ...
        //拨打电话
        public SingleLiveEvent<Boolean> phoneCall = new SingleLiveEvent<>();
    }

    public PhoneViewModel(@NonNull Application application, DemoRepository repository) {
